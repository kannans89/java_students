<%@page import="com.techlabs.controllers.components.PassbookEntry"%>
    		...
    		<div class="heading5" style="font-family: Georgia, serif;">
                		...
                		<div class="collapse navbar-collapse">
                    		<ul class="nav navbar-nav">
								...
								<li><a href="passbook" style="color: black;">Pass Book</a></li>
                    		</ul>
			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div class="transBlockWhite" style="min-height: 500px; padding-left: 20px; padding-right: 20px; padding-bottom: 40px;">
                    	<div class="heading2">Pass Book </div><br><br>
                    		<br>
                    	...
                    	<div class="table-responsive" style="text-align: left; border: 2px solid black;">
        					<table class="table" style="font-size: 20px; font-weight: 700">
            					<thead>
               						<tr>
               							<th  style="border-bottom: 3px solid black;">Sr. No.</th>
               							<th  style="border-bottom: 3px solid black;">Transaction ID</th>
                   						<th  style="border-bottom: 3px solid black;">Date</th>
                   						<th  style="border-bottom: 3px solid black;">Withdraw</th>
                   						<th  style="border-bottom: 3px solid black;">Deposit</th>
           						...
           						<tbody>
           							<%	@SuppressWarnings("unchecked")
										List<PassbookEntry> entries = (List<PassbookEntry>) request.getAttribute("entries");
                					...
                					<tr>
                    					<td><%= entry.getSrNo()%></td>
                    					<td><%= entry.getTransactionID()%></td>
                    					<td><%= entry.getDate()%></td>
                    					<td>Rs. <%= entry.getWithdraw()%></td>
                    					<td>Rs. <%= entry.getDeposit()%></td>
                   						<td>Rs. <%= entry.getBalance()%></td>
               						</tr>
    					...
    					<br><br>
    					<form method="post" action="passbook" style="text-align: center; padding-left: 10%; padding-right: 10%;">
                    		<div class="heading4" style="font-family: Arial, Helvetica, sans-serif;">
								<input type="submit" value="OK" style="width: 150px;" name="submit">
								<input type="submit" value="Download" name="passbook">
							</div>
						</form>
