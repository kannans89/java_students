...
<%@page import="com.techlabs.controllers.components.Transaction"%>
    		...
    		<div class="heading5" style="font-family: Georgia, serif;">
                		...
                		<div class="collapse navbar-collapse">
                    		<ul class="nav navbar-nav">
                        		...
                        		<li><a href="transactionsTable" style="color: black;">Transactions Table</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div class="transBlockWhite" style="min-height: 500px; padding-left: 20px; padding-right: 20px; padding-bottom: 40px;">
                    	<div class="heading2">Transactions Table </div><br><br>
                    		<br>
        					...
        					<table class="table" style="font-size: 20px; font-weight: 700">
            					<thead>
               						<tr>
                   						...
                   						<th  style="border-bottom: 3px solid black;">Amount</th>
               						</tr>
           						</thead>
    					...
    					<br><br>
    					<form method="post" action="transactionsTable" style="text-align: center; padding-left: 10%; padding-right: 10%;">
