	...
	<div class="container">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="editEmployee" method="post" id="addEmployeeForm">
					<div class="form-group">
						<label for="empid">Employee Id</label> <br> <input
							type="number" name="empid" class="form-group" disabled id="empid"
							placeholder="Employee Id" value="<%=empId%>"> <span
							id="errorId" style="color: red;"></span>
					</div>
					<div class="form-group">
						<label for="empname">Employee Name</label> <br> <input
							type="text" name="empname" class="form-group" id="empname"
							placeholder="Employee Name" value="<%=editEmp.getEmpName()%>">
					...
					<div class="form-group">
						<label for="empDeptNo">Department Name</label> <br> <select
							...
							<%if(department.getDeptId()!=editEmp.getDeptNo()){ %>
							<option value="<%=department.getDeptId()%>"><%=department.getDeptName()%></option>
							<%}else{ %>
							<option value="<%=department.getDeptId()%>" selected="selected"><%=department.getDeptName()%></option>
							<%}}}else{%>
